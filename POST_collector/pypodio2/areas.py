...
class Org(Area):
    ...
    def get_all_members(self, org_id):
        return self.transport.GET(url='/org/%s/member' % org_id)
...
class Notification(Area):
    ...
    def find_all(self,attributes):
        attributes = json.dumps(attributes)
        return self.transport.GET(url='/notification/', body=attributes)
...
class Files(Area):
    ...
    def create(self, filename, filedata):
        ...
        attributes = {'filename': filename,
                      'source': filedata}
        #return self.transport.POST(url='/file/', body=(attributes), type='multipart/form-data')
...
class SpaceMember(Area):


    def find_all(self, space_id):
